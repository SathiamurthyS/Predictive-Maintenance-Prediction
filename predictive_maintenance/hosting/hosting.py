...
api.upload_folder(
    folder_path="predictive_maintenance/deployment_fe",     # the local folder containing your files
...
api.upload_folder(
    folder_path="predictive_maintenance/deployment_be",     # the local folder containing your files
